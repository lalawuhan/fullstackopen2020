...
const Anecdote = ({ anecdote }) => {
  ...
  return (
    <>
      ...
      <p>For more information: <a href={anecdote.info}>click here</a></p>
    </>)
}
...
const App = () => {
  ...
  const matchingAnecdote = match ? anecdotes.find(n => n.id === match.params.id) : null
  return (
    <div>
      <h1>Software anecdotes</h1>
      <Link to="/menu" style={padding}>menu</Link>
      {notification
        ? <em>{notification}</em>
        : null
      }
